...
/* harmony import */ var _models_store_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/store-model */ "./src/models/store-model.js");
  ...
  getData() {
    ...
    return Promise.all(requests)
      ...
      .then((responses) => {
        ...
        _models_store_model__WEBPACK_IMPORTED_MODULE_1__["default"].setAllDestinations(destinations);
        _models_store_model__WEBPACK_IMPORTED_MODULE_1__["default"].setOffers(offers);
        return points;
      })
...
class Provider {
  ...
  getData() {
    ...
    return Promise.resolve(_models_point_model__WEBPACK_IMPORTED_MODULE_1__["default"].parsePoints(storePoints));
  }
  ...
  createPoint(point) {
    ...
    const fakeNewPoint = _models_point_model__WEBPACK_IMPORTED_MODULE_1__["default"].parsePoint(Object.assign({}, point.toRAW(), {id: fakeNewPointId}));
    this._isSynchronized = false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CardComponent; });
  ...
  return (
    `<li class="trip-events__item">
        <div class="event">
          ...
          <h3 class="event__title">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatCardTitle"])(card)} ${card.destination.name}</h3>
          <div class="event__schedule">
            <p class="event__time">
              <time class="event__start-time" datetime="${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["setDateTimeAttr"])(card.startTime)}">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(card.startTime)}</time>
              &mdash;
              <time class="event__end-time" datetime="${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["setDateTimeAttr"])(card.endTime)}">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["formatTime"])(card.endTime)}</time>
            </p>
            <p class="event__duration">${Object(_utils_common__WEBPACK_IMPORTED_MODULE_0__["getDuration"])(card.startTime, card.endTime)}</p>
          </div>
...
class CardComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(card) {
    super();
    this._card = card;
...
/***/ "./src/components/card-edit-component.js":
/*!***********************************************!*\
  !*** ./src/components/card-edit-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var _models_store_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/store-model */ "./src/models/store-model.js");
                    ...
                    <header class="event__header">
                      ...
                      <div class="event__field-group  event__field-group--destination">
                        <label class="event__label  event__type-output" for="event-destination-1">
                          ${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["formatCardTitle"])(card)}
                        </label>
                      ...
                      <div class="event__field-group  event__field-group--time">
                        ...
                        <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["setDateTimeAttr"])(card.startTime)}">
                        &mdash;
                        <label class="visually-hidden" for="event-end-time-1">
                          To
                        </label>
                        <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["setDateTimeAttr"])(card.startTime)}">
                      </div>
...
class CardEdit extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(card) {
    super();
    this._card = card;
    ...
    this._destinations = _models_store_model__WEBPACK_IMPORTED_MODULE_2__["default"].getAllDestinations();
    this._offers = _models_store_model__WEBPACK_IMPORTED_MODULE_2__["default"].getOffers();
  ...
  setFavoriteButtonClickHandler(handler) {
    this._favoriteBtn.addEventListener(`click`, lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()(handler, DEBOUNCE_TIMEOUT));
  ...
  _applyFlatpickr() {
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(startTimeElement, {
      allowInput: true,
      enableTime: true,
    ...
    this._flatpickr = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(endTimeElement, {
      allowInput: true,
      enableTime: true,
      dateFormat: `d/m/Y H:i`,
...
/*!*********************************!*\
  !*** ./src/components/index.js ***!
  \*********************************/
/*! exports provided: MenuComponent, SortComponent, FilterComponent, RouteComponent, CardComponent, CardEdit, TripDaysComponent, NoCardsComponent, TripListComponent, SortType, StatisticsComponent, MenuItem, TripEventsComponent, PriceComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _menu_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./menu-component */ "./src/components/menu-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MenuComponent", function() { return _menu_component__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MenuItem", function() { return _menu_component__WEBPACK_IMPORTED_MODULE_0__["MenuItem"]; });

/* harmony import */ var _sort_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sort-component */ "./src/components/sort-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SortComponent", function() { return _sort_component__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _filter_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./filter-component */ "./src/components/filter-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FilterComponent", function() { return _filter_component__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _route_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./route-component */ "./src/components/route-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RouteComponent", function() { return _route_component__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _card_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./card-component */ "./src/components/card-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CardComponent", function() { return _card_component__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _card_edit_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./card-edit-component */ "./src/components/card-edit-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CardEdit", function() { return _card_edit_component__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony import */ var _trip_days_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./trip-days-component */ "./src/components/trip-days-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TripDaysComponent", function() { return _trip_days_component__WEBPACK_IMPORTED_MODULE_6__["default"]; });

/* harmony import */ var _no_cards_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./no-cards-component */ "./src/components/no-cards-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "NoCardsComponent", function() { return _no_cards_component__WEBPACK_IMPORTED_MODULE_7__["default"]; });

/* harmony import */ var _trip_list_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./trip-list-component */ "./src/components/trip-list-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TripListComponent", function() { return _trip_list_component__WEBPACK_IMPORTED_MODULE_8__["default"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SortType", function() { return _sort_component__WEBPACK_IMPORTED_MODULE_1__["SortType"]; });

/* harmony import */ var _statistics_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./statistics-component */ "./src/components/statistics-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "StatisticsComponent", function() { return _statistics_component__WEBPACK_IMPORTED_MODULE_9__["default"]; });

/* harmony import */ var _trip_events_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./trip-events-component */ "./src/components/trip-events-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TripEventsComponent", function() { return _trip_events_component__WEBPACK_IMPORTED_MODULE_10__["default"]; });

/* harmony import */ var _price_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./price-component */ "./src/components/price-component.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PriceComponent", function() { return _price_component__WEBPACK_IMPORTED_MODULE_11__["default"]; });
...
class MenuComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
  }
...
/***/ "./src/components/no-cards-component.js":
/*!**********************************************!*\
  !*** ./src/components/no-cards-component.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoCardsComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class NoCardsComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/price-component.js":
/*!*******************************************!*\
  !*** ./src/components/price-component.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PriceComponent; });
...
class PriceComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/***/ "./src/components/route-component.js":
/*!*******************************************!*\
  !*** ./src/components/route-component.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RouteComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class RouteComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class SortComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/***/ "./src/components/statistics-component.js":
/*!************************************************!*\
  !*** ./src/components/statistics-component.js ***!
  \************************************************/
/*! exports provided: default */
...
const getDuration = (start, end) => {
  const startTime = moment__WEBPACK_IMPORTED_MODULE_1___default()(start);
  const endTime = moment__WEBPACK_IMPORTED_MODULE_1___default()(end);
  const diff = endTime.diff(startTime);

  return moment__WEBPACK_IMPORTED_MODULE_1___default()(diff);
};
...
const renderPriceChart = (priceCtx, cards) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(priceCtx, {
...
const renderTimeSpentChart = (timeSpentCtx, cards) => {
  ...
  const data = destinations.map((destination) => {
    return {
      destination,
      duration: moment__WEBPACK_IMPORTED_MODULE_1___default()(calcTimeSpent(cards, destination)).format(`HH`)
    };
  })
    .sort((a, b) => b.duration - a.duration);
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(timeSpentCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3___default.a],
    type: `horizontalBar`,
    data: {
...
class StatisticsComponent extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(cards) {
    super();
    this._cards = cards;
...
/***/ "./src/components/trip-days-component.js":
/*!***********************************************!*\
  !*** ./src/components/trip-days-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
class TripDaysComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
/***/ "./src/components/trip-events-component.js":
/*!*************************************************!*\
  !*** ./src/components/trip-events-component.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripEventsComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class TripEventsComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/***/ "./src/components/trip-list-component.js":
/*!***********************************************!*\
  !*** ./src/components/trip-list-component.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TripListComponent; });
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
...
class TripListComponent extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
/* harmony import */ var _trip_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./trip-controller */ "./src/controller/trip-controller.js");
...
/* harmony import */ var _filter_controller__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filter-controller */ "./src/controller/filter-controller.js");
/* harmony import */ var _api_index__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../api/index */ "./src/api/index.js");
/* harmony import */ var _api_backup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../api/backup */ "./src/api/backup.js");
...
const AUTHORIZATION = `Basic ` + Object(_utils_common__WEBPACK_IMPORTED_MODULE_9__["getRandomString"])();
const END_POINT = `https://htmlacademy-es-10.appspot.com/big-trip`;

class AppController {
  constructor() {
    this._api = new _api_index__WEBPACK_IMPORTED_MODULE_5__["default"](END_POINT, AUTHORIZATION);
    this._backup = new _api_backup__WEBPACK_IMPORTED_MODULE_6__["default"](BACKUP_NAME, window.localStorage);
    this._apiWithProvider = new _api_provider__WEBPACK_IMPORTED_MODULE_7__["default"](this._api, this._backup);
    this._siteMenuComponent = new _components_index__WEBPACK_IMPORTED_MODULE_1__["MenuComponent"]();

    this._pointModel = new _models_points_model__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._tripEvents = new _components_index__WEBPACK_IMPORTED_MODULE_1__["TripEventsComponent"]();
    this._priceComponent = new _components_index__WEBPACK_IMPORTED_MODULE_1__["PriceComponent"]();
    this._routeComponent = new _components_index__WEBPACK_IMPORTED_MODULE_1__["RouteComponent"]();

    this._trip = new _trip_controller__WEBPACK_IMPORTED_MODULE_2__["default"](this._tripEvents, this._pointModel, this._apiWithProvider);
  ...
  render() {
    this._statisticsComponent = new _components_index__WEBPACK_IMPORTED_MODULE_1__["StatisticsComponent"](this._pointModel);
    ...
    const filterController = new _filter_controller__WEBPACK_IMPORTED_MODULE_4__["default"](siteHeaderControls, this._pointModel);
    const tripRoute = document.querySelector(`.trip-info`);

    this._setEventAddBtn();

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(siteHeaderControls, this._siteMenuComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(mainElementContainer, this._tripEvents, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(mainElementContainer, this._statisticsComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    ...
    this._apiWithProvider.getData()
      .then((points) => {
        ...
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(tripRoute, this._routeComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].AFTERBEGIN);
        this._routeComponent.setRoute(points);
        filterController.render();
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(tripRoute, this._priceComponent, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
        this._trip.render();
  ...
  _setSiteNavigation() {
    this._siteMenuComponent.setOnClick((menuItem) => {
      switch (menuItem) {
        case _components_index__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS:
          this._trip.hide();
          this._statisticsComponent.show();
          break;
        case _components_index__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE:
          this._statisticsComponent.hide();
          this._trip.show();
          break;
      }
...
/***/ "./src/controller/filter-controller.js":
/*!*********************************************!*\
  !*** ./src/controller/filter-controller.js ***!
  \*********************************************/
/*! exports provided: default */
...
class FilterController {
  constructor(container, pointModel) {
    ...
    this._activeFilterType = _const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].EVERYTHING;
  ...
  render() {
    const filters = Object.values(_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
    ...
    this._filterComponent = new _components__WEBPACK_IMPORTED_MODULE_1__["FilterComponent"](filters);
    ...
    if (oldComponent) {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._filterComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }
...
/***/ "./src/controller/point-controller.js":
/*!********************************************!*\
  !*** ./src/controller/point-controller.js ***!
  \********************************************/
/*! exports provided: default, Mode, EmptyCard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const parseFormData = (formData, offers) => {
  ...
  return new _models_point_model__WEBPACK_IMPORTED_MODULE_3__["default"]({
    ...
    'date_from': Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["formatAfterFlatpickr"])(formData.get(`event-start-time`)),
    'date_to': Object(_utils_common__WEBPACK_IMPORTED_MODULE_4__["formatAfterFlatpickr"])(formData.get(`event-end-time`)),
    'offers': offers,
...
class PointController extends _components_abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  render(card, mode) {
    ...
    this._cardComponent = new _components__WEBPACK_IMPORTED_MODULE_2__["CardComponent"](card);
    this._cardEditComponent = new _components__WEBPACK_IMPORTED_MODULE_2__["CardEdit"](card);
    ...
    switch (mode) {
      case Mode.DEFAULT:
        if (oldCardEditComponent && oldCardComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._cardComponent, oldCardComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._cardEditComponent, oldCardEditComponent);
          this._replaceEditToCard();
        } else {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._cardComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
        }
        break;
      case Mode.ADDING:
        if (oldCardEditComponent && oldCardComponent) {
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(oldCardComponent);
          Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(oldCardEditComponent);
        }
        document.addEventListener(`keydown`, this._escKeyDownHandler);
        this._cardEditComponent.setData({
        ...
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._cardEditComponent, _utils_render__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
        break;
    }
  }
  ...
  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._cardEditComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._cardComponent);
    document.removeEventListener(`keydown`, this._escKeyDownHandler);
  }
  ...
  _replaceEditToCard() {
    ...
    if (document.contains(this._cardEditComponent.getElement())) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._cardComponent, this._cardEditComponent);
    }
    this._mode = Mode.DEFAULT;
  }
  ...
  _replaceCardToEdit() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._cardEditComponent, this._cardComponent);
...
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render */ "./src/utils/render.js");
/* harmony import */ var _components_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/index */ "./src/components/index.js");
/* harmony import */ var _point_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./point-controller */ "./src/controller/point-controller.js");
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/common */ "./src/utils/common.js");
...
const renderCards = (container, cards, dataChangeHandler, viewChangeHandler, mode, isSortedByDefault) => {
  ...
  const tripDates = isSortedByDefault ? [...Object(_utils_common__WEBPACK_IMPORTED_MODULE_3__["getTripDates"])(cards)].sort((a, b) => a - b) : [true];

  tripDates.forEach((it, index) => {
    const day = isSortedByDefault ? new _components_index__WEBPACK_IMPORTED_MODULE_1__["TripDaysComponent"](moment__WEBPACK_IMPORTED_MODULE_4___default()().dayOfYear(it), index + 1) : new _components_index__WEBPACK_IMPORTED_MODULE_1__["TripDaysComponent"]();

    cards
      .filter((card) => {
        return isSortedByDefault ? moment__WEBPACK_IMPORTED_MODULE_4___default()(card.startTime).dayOfYear() === it : card;
      })
      .forEach((card) => {
        const pointController = new _point_controller__WEBPACK_IMPORTED_MODULE_2__["default"](day.getElement().querySelector(`.trip-events__list`), dataChangeHandler, viewChangeHandler);
        pointController.render(card, mode);

        controllers.push(pointController);
      });
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container.getElement(), day, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
  });
...
class TripController {
  constructor(container, pointModel, api) {
    ...
    this._emptyCard = Object.assign({}, _point_controller__WEBPACK_IMPORTED_MODULE_2__["EmptyCard"]);
    this._showedCardControllers = [];
    this._creatingCard = null;
    this._isSortedByDefault = true;
    this._totalPrice = null;

    this._noCards = new _components_index__WEBPACK_IMPORTED_MODULE_1__["NoCardsComponent"]();
    this._sort = new _components_index__WEBPACK_IMPORTED_MODULE_1__["SortComponent"]();
    this._tripList = new _components_index__WEBPACK_IMPORTED_MODULE_1__["TripListComponent"]();
  ...
  render() {
    ...
    if (!cards.length) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._noCards, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    }
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._sort, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_0__["render"])(container, this._tripList, _utils_render__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    ...
    this._showedCardControllers = renderCards(
        ...
        this._viewChangeHandler,
        _point_controller__WEBPACK_IMPORTED_MODULE_2__["Mode"].DEFAULT,
  ...
  createCard() {
    ...
    this._creatingCard = new _point_controller__WEBPACK_IMPORTED_MODULE_2__["default"](this._tripList.getElement(), this._dataChangeHandler, this._viewChangeHandler);
    this._creatingCard.render(this._emptyCard, _point_controller__WEBPACK_IMPORTED_MODULE_2__["Mode"].ADDING);
  }
  ...
  _dataChangeHandler(pointController, oldData, newData) {
    if (oldData === this._emptyCard || oldData === _point_controller__WEBPACK_IMPORTED_MODULE_2__["EmptyCard"]) {
      this._creatingCard = null;
      if (newData === null) {
      ...
      this._api.updatePoint(oldData.id, newData)
        .then((pointModel) => {
          ...
          if (isSuccess) {
            pointController.render(pointModel, _point_controller__WEBPACK_IMPORTED_MODULE_2__["Mode"].DEFAULT);
            this._updateCards();
          }
        })
        .catch(() => {
  ...
  _sortTypeChangeHandler(sortType) {
    ...
    switch (sortType) {
      case _components_index__WEBPACK_IMPORTED_MODULE_1__["SortType"].TIME:
        this._isSortedByDefault = false;
        sortedCards = cards.slice().sort((a, b) => (b.endTime - b.startTime) - (a.endTime - a.startTime));
        break;
      case _components_index__WEBPACK_IMPORTED_MODULE_1__["SortType"].PRICE:
        this._isSortedByDefault = false;
        sortedCards = cards.slice().sort((a, b) => b.price - a.price);
        break;
      case _components_index__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT:
        this._isSortedByDefault = true;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _controller_app_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./controller/app-controller */ "./src/controller/app-controller.js");


const app = new _controller_app_controller__WEBPACK_IMPORTED_MODULE_0__["default"]();
app.registerSW();
app.render();
app.syncSW();
app.isOffline();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PointModel; });
class PointModel {
  constructor(data) {
    this.id = data[`id`];
    this.type = data[`type`];
...
class PointsModel {
  ...
  getPoints() {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_1__["getCardsByFilter"])(this._cards, this._activeFilterType);
  }

  getPointsByFilter(filterType) {
    return Object(_utils_filter__WEBPACK_IMPORTED_MODULE_1__["getCardsByFilter"])(this._cards, filterType);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return StoreModel; });
class StoreModel {
  constructor() {
    this._destinations = [];
    this._offers = [];
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatTime, getDuration, setDateTimeAttr, isOverdueDate, isFutureDate, getTripDates, formatAfterFlatpickr, formatCardTitle, getRandomString */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setDateTimeAttr", function() { return setDateTimeAttr; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatAfterFlatpickr", function() { return formatAfterFlatpickr; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatCardTitle", function() { return formatCardTitle; });
...
const setDateTimeAttr = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).toISOString();
};

const formatAfterFlatpickr = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date, `DD/MM/YYYY HH:mm`);
};

const getDuration = (start, end) => {
  let startTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(start);
  let endTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(end);
  const diff = endTime.diff(startTime);

  if (diff < HOUR_PER_MS) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default()(diff).format(`mm`) + `M`;
  } else if (diff < DAY_PER_MS) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default()(diff).format(`HH`) + `H` + ` ` + moment__WEBPACK_IMPORTED_MODULE_0___default()(diff).format(`mm`) + `M`;
  } else {
    return moment__WEBPACK_IMPORTED_MODULE_0___default()(diff).format(`DD`) + `D` + ` ` + moment__WEBPACK_IMPORTED_MODULE_0___default()(diff).format(`HH`) + `H` + ` ` + moment__WEBPACK_IMPORTED_MODULE_0___default()(diff).format(`mm`) + `M`;
  }
};

const getTripDates = (cards) => {
  return new Set(cards.map((it) => moment__WEBPACK_IMPORTED_MODULE_0___default()(it.startTime).dayOfYear()));
};
...
const getFutureCards = (cards, date) => {
  return cards.filter((card) => {
    ...
    return Object(_common__WEBPACK_IMPORTED_MODULE_1__["isFutureDate"])(startTime, date);
  });
};
...
const getPastCards = (cards, date) => {
  return cards.filter((card) => {
    ...
    return Object(_common__WEBPACK_IMPORTED_MODULE_1__["isOverdueDate"])(startTime, date);
  });
};
...
/* harmony import */ var dompurify_dist_purify_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dompurify/dist/purify.min */ "./node_modules/dompurify/dist/purify.min.js");
/* harmony import */ var dompurify_dist_purify_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dompurify_dist_purify_min__WEBPACK_IMPORTED_MODULE_0__);
...
const createElement = (template) => {
  ...
  newElement.innerHTML = dompurify_dist_purify_min__WEBPACK_IMPORTED_MODULE_0___default.a.sanitize(template);
